    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto relative mt-12">
          ...
          <div className="absolute right-4 -top-10 no-print z-10 flex space-x-3 items-center">
            ...
            />
            <button onClick={handleSearch} className="px-3 py-1 bg-blue-500 text-white rounded mr-2">Search</button>
            <button onClick={fetchPatients} className="px-3 py-1 bg-gray-200 rounded mr-2">Refresh</button>
            <button
